...
final class EncodingErrorTests: XCTestCase {
    ...
    class BaseClass: Codable, Equatable {
        ...
        static func == (
            lhs: EncodingErrorTests.BaseClass,
            rhs: EncodingErrorTests.BaseClass
        ) -> Bool {
    ...
    func testEncodingError() throws {
            ...
            override func encode(to encoder: any Encoder) throws {
                throw EncodingError.invalidValue(
                    ...
                    EncodingError.Context(
                        ...
                        debugDescription: EncodingErrorTests.encodingErrorSnippet
                    )
                )
            }
        }
        ...
        do {
            ...
            XCTAssertTrue(error.debugDescription.contains(EncodingErrorTests.encodingErrorSnippet))
        } catch {
            XCTFail(error.localizedDescription)
        }
    }
