...
extension Shell {
    ...
    public struct Command {
        ...
        /// A shell command & arguments preceded by 
        ///
        /// # EX:
        /// ```sh
        /// which plantuml
        ...
        /// - Parameters:
        ///   - executableURL: A `URL` to the executable file. Defaults to `/usr/bin/env'`
        ...
        ///   - redirectToPipe: Routes output to stdout or a pipe to the next `Command`.
        ///   - stdinPipe: A `Pipe`instance representing output from a previous `Response`
        public init(
...
extension Shell.Command: CustomDebugStringConvertible {
