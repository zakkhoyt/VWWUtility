...
//        )
        ...
        func color(index: Int) -> UIColor {
            switch index {
            case 0: return UIColor(hexString: "#FE1060")
            case 1: return UIColor(hexString: "#3BC3FE")
            case 2: return UIColor(hexString: "#0FFEB3")
            case 3: return UIColor(hexString: "#E3C854")
